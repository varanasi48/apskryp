      ...
      const [formData, setFormData] = useState({
        ...
        const handleInputChange = (event) => {
          ...
          const handleSubmit = async (event) => {
           ...
           formSubmitted.doi=formData.doi.toString()
   ...
   /* <CAlert color='secondary' dismissible visible={visible} onClose={onclose }>
    ...
    return(
      ...
      >
        ...
        <DemoItem label="Date of Investment">
          <DatePicker name="doi" type="date" value={formData.doi.toString()} onChange={handleInputChange} defaultValue={dayjs('2022-04-17')} />
        </DemoItem>
      ...
      >
        ...
        <DemoItem label="Responsive variant">
          <DatePicker name="doi" type="date" value={formData.doi} onChange={handleInputChange} defaultValue={dayjs('2022-04-17')} />
        </DemoItem>
